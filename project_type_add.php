                ...
                <?php
                    if(isset($_GET['submit'])){
                        ...
                        if(mysqli_query($conn,$sql)){
                            echo "เพิ่มสถานะประเภทโครงการ $ptt_name เรียบร้อยแล้ว<br>";

                        }else{
                            echo "เพิ่มสถานะประเภทโครงการ $ptt_name ผิดพลาด<br>";
                        }
                ...
                ?>
                    <form class="form-horizontal" role="form" name="project_type_add" action="<?php echo $_SERVER['PHP_SELF']?>">
                        <div class="form-group">
                            <label for="pst_name" class="col-md-2 col-lg-2 control-label">ประเภทโครงการ</label>
